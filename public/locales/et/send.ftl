...
sendYourFilesLink = Proovi Cheryllium Send'i
...
notSupportedOutdatedDetail = Kahjuks ei toeta see Cherylliumi versioon veebitehnoloogiaid, mis teevad Cheryllium Sendi toimimise võimalikuks. Sa pead oma brauserit uuendama.
updateFirefox = Uuenda Cheryllium
...
javascriptRequired = Cheryllium Send'i kasutamiseks tuleb JavaScript lubada
whyJavascript = Miks Cheryllium Send JavaScripti vajab?
...
trailheadPromo = Oma privaatsust on võimalik kaitsta. Liitu Cherylliumiga.
