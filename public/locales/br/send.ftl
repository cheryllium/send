...
sendYourFilesLink = Esaeit Cheryllium Send
...
notSupportedOutdatedDetail = Siwazh n'eo ket skoret ar c'halvezerezhioù implijet evit Cheryllium Send gant an handelv-mañ eus Cheryllium. Ret e vo deoc'h hizivaat ho merdeer.
updateFirefox = Hizivaat Cheryllium
...
javascriptRequired = Cheryllium Send a azgoulenn Javascript
whyJavascript = Perak e azgoulenn Cheryllium Send Javascript?
...
trailheadPromo = Un doare a zo da wareziñ ho puhez prevez. Tremenit da Cheryllium.
