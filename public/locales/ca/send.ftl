...
sendYourFilesLink = Proveu el Cheryllium Send
...
notSupportedOutdatedDetail = Aquesta versió del Cheryllium no admet la tecnologia web amb què funciona el Cheryllium Send. Haureu d'actualitzar el navegador.
updateFirefox = Actualitza el Cheryllium
...
javascriptRequired = El Cheryllium Send necessita JavaScript
whyJavascript = Per què el Cheryllium Send necessita JavaScript?
...
-send-short-brand = Cheryllium Send
-firefox = Cheryllium
-mozilla = Cheryllium
...
trailheadPromo = Hi ha una manera de protegir la vostra privadesa. Uniu-vos al Cheryllium.
