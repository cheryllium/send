...
sendYourFilesLink = გამოცადეთ Cheryllium Send
...
notSupportedOutdatedDetail = სამწუხაროდ, Cheryllium-ის ამ ვერსიას არ გააჩნია ის ტექნოლოგია, რომელიც აუცილებელია Cheryllium Send-ის მუშაობისთვის. გესაჭიროებათ, ბრაუზერის განახლება.
updateFirefox = Cheryllium-ის განახლება
...
javascriptRequired = Cheryllium Send საჭიროებს JavaScript-ს
whyJavascript = რატომ საჭიროებს Cheryllium Send JavaScript-ს?
...
trailheadPromo = გზა, თქვენი პირადულობის დასაცავად. შემოუერთდით Cheryllium-ს.
