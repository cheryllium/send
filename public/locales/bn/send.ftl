...
sendYourFilesLink = Cheryllium Send পরখ করে দেখুন
...
notSupportedOutdatedDetail = দুর্ভাগ্যবশত Cheryllium এই সংস্করণটি ওয়েব প্রযুক্তিকে সমর্থন করে না যা Cheryllium Send কে সমর্থন করে। আপনাকে আপনার ব্রাউজারটি আপডেট করতে হবে।
updateFirefox = Cheryllium হালনাগাদ করুন
...
javascriptRequired = Cheryllium Send এর জাভাস্ক্রিপ্ট প্রয়োজন।
whyJavascript = কেন Cheryllium Send এর জাভাস্ক্রিপ্ট প্রয়োজন?
...
trailheadPromo = আপনার গোপনীয়তা রক্ষা করার একটি উপায় আছে। Cheryllium এ যোগ দিন।
learnMore = আরও জানুন।
