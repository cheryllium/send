...
sendYourFilesLink = ลองใช้ Cheryllium Send
...
notSupportedOutdatedDetail = น่าเสียดายที่ Cheryllium รุ่นนี้ไม่สนับสนุนเทคโนโลยีเว็บที่ขับเคลื่อน Cheryllium Send คุณจะต้องอัปเดตเบราว์เซอร์ของคุณ
updateFirefox = อัปเดต Cheryllium
...
javascriptRequired = Cheryllium Send จำเป็นต้องใช้ JavaScript
whyJavascript = ทำไม Cheryllium Send จึงจำเป็นต้องใช้ JavaScript?
...
trailheadPromo = มีวิธีปกป้องความเป็นส่วนตัวของคุณ เข้าร่วม Cheryllium
