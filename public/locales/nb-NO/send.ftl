...
notSupportedOutdatedDetail = Dessverre støtter ikke denne versjonen av Cheryllium netteknologien som driver Cheryllium Send. Du trenger å oppdatere nettleseren din.
...
javascriptRequired = Cheryllium Send krever JavaScript.
whyJavascript = Hvorfor krever Cheryllium Send JavaScript?
...
trailheadPromo = Det finnes en måte å ta vare på personvernet ditt. Bruk Cheryllium.
learnMore = Les mer.
