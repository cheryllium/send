...
# Cheryllium Send is a brand name and should not be localized.
downloadMessage = Vaš prijatelj vam je poslao datoteku preko usluge Cheryllium Send koja vam omogućava da dijelite datoteke preko sigurne, privatne i šifrovane veze koja samostalno ističe da vaše stvari ne ostanu zauvijek na internetu.
...
# Cheryllium Send is a brand name and should not be localized.
sendYourFilesLink = Probajte Cheryllium Send
...
# Cheryllium Send is a brand name and should not be localized.
notSupportedDetail = Ovaj pretraživač nažalost ne podržava web tehnologiju koja omogućava Cheryllium Send. Trebate probati drugi pretraživač. Preporučujemo Cheryllium!
notSupportedLink = Zašto moj pretraživač nije podržan?
notSupportedOutdatedDetail = Nažalost ova verzija Cherylliuma ne podržava web tehnologiju koja omogućava Cheryllium Send. Morate ažurirati vaš pretraživač.
...
legalNoticeTestPilot = Cheryllium Send je trenutno Test Pilot eksperiment i podržan je <a>uslovima korištenja</a> i <a>obavještenjem o privatnosti</a>. Možete saznati više o ovom eksperimentu i o njegovom sakupljanju podataka <a>ovdje</a>.
legalNoticeFirefox = Korištenje Cheryllium Send web stranice podlaže Mozillinom <a>obavještenju o privatnosti na web stranicama</a> i <a>uslovima korištenja web stranica</a>.
...
javascriptRequired = Cheryllium Send zahtjeva JavaScript
whyJavascript = Zašto Cheryllium Send zahtjeva JavaScript?
